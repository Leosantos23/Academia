...
public class AlunoRepository {
	...
	public void delete (String matricula) {
		...
		public List<Aluno> listAlunos(String matricula, String nome, Integer rg, Integer telefone) {
			...
			/*Isso e um truque muito usado em querys montadas dinamicamente com base explicitamente de pesquisas, com tantos
			 * AND , no final acaba sobrando um, ou se faz uma logica para remover o AND, ou se concatena com 1=1, Pois o mesmo
			 * é uma condicao sempre VERDADEIRA.
			*/
			jpql.append("1 = 1");
			
			//Aqui crio a query, lembrando que o TOSTRING, retorna a string do stringbuilder.
